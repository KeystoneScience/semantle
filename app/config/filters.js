...
const companies = [
  {
    src: require("../assets/filterIcons/companyLogos/netflix.png"),
    id: "8", //netflix
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/disneyplus.png"),
    id: "337", //disney plus
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/hulu.png"),
    id: "15", //hulu
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/hbomax.png"),
    id: "384", //HBO max
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/primevideo.png"),
    id: "9", //prive video
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/peacock.png"),
    id: "387", //peacock premium, regular is 386
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/sling.png"),
    id: "299", //sling tv
    section: "providers",
    isNotPressed: true,
  },
  {
    src: require("../assets/filterIcons/companyLogos/crunchyroll.png"),
    id: "283",
    section: "providers",
    isNotPressed: true,
  },
...
const type = [
  {
    src: require("../assets/filterIcons/typeLogos/movie.png"),
    id: "movie",
    section: "type",
    isNotPressed: false,
  },
  {
    src: require("../assets/filterIcons/typeLogos/tv.png"),
    id: "tv",
    section: "type",
    isNotPressed: true,
  },
  ...
  tv_certifications: {
    ...
    CA: [
      {
        certification: "18+",
        meaning:
          "Programming intended for viewers ages 18 and older. May contain explicit violence and sexual activity. Programming with this rating cannot air before the watershed (9:00 p.m. to 6:00 a.m.).",
        order: 6,
      },
      {
        certification: "PG",
        meaning:
          "Parental guidance. Moderate violence and moderate profanity is allowed, as is brief nudity and sexual references if important to the context of the story.",
        order: 4,
      },
      {
        certification: "14+",
      ...
      },
      {
        certification: "C8",
        meaning:
          'Suitable for children ages 8+. Low level violence and fantasy horror is allowed. No foul language is allowed, but occasional "socially offensive and discriminatory" language is allowed if in the context of the story. No sexual content of any level allowed.',
        order: 2,
      },
      {
        certification: "C",
        meaning:
          "Programming suitable for children ages of 2–7 years. No profanity or sexual content of any level allowed. Contains little violence.",
        order: 1,
      },
    ],
    AU: [
      ...
      },
      {
        certification: "MA15+",
        meaning:
          'Not suitable for children and teens under 15; MA15+-rated programming may only be broadcast between 9:00 p.m. and 5:00 a.m. on any given day. Consumer advice is mandatory. Some R18+ rated movies on DVD/Blu-ray are often re-edited on free TV/cable channels to secure a more "appropriate" MA15+ rating. Some movies that were rated R18 on DVD have since been aired in Australian TV with MA15+ rating.',
        order: 6,
      },
      {
        certification: "R18+",
        meaning:
          'Not for children under 18; this is limited to Adult "Pay Per View" VC 196 and 197. Content may include graphic violence, sexual situations, coarse language and explicit drug use.',
        order: 8,
      },
      {
        certification: "P",
    ...
    TH: [
      ...
      },
      {
        certification: "น 15+",
        meaning:
          "Nor 15+ Movies appropriate for audiences aged 15 and older. Some violence, brutality, inhumanity, bad language or indecent gestures allowed.",
        order: 3,
      },
      {
        certification: "ส",
      ...
      },
      {
        certification: "ท",
        meaning:
          "Tor - G Movies appropriate for the general public. No sex, abusive language or violence.",
        order: 1,
      },
      {
        certification: "ฉ 20-",
    ...
    KR: [
      {
        certification: "7",
        meaning:
          'This rating is for programming that may contain material inappropriate for children younger than 7, and parental discretion should be used. Some cartoon programming not deemed strictly as "educational", and films rated "G" or "PG" in North America may fall into the 7 category.',
        order: 2,
      },
      {
        certification: "ALL",
        meaning:
          "This rating is for programming that is appropriate for all ages. This program usually involves programs designed for children or families.",
        order: 1,
      },
      {
        certification: "15",
      ...
      },
      {
        certification: "12",
        meaning:
          "This rating is for programs that may deemed inappropriate for those younger than 12, and parental discretion should be used. Usually used for animations that have stronger themes or violence then those designed for children, or for reality shows that have mild violence, themes, or language.",
        order: 3,
      },
      {
        certification: "19",
        meaning:
          "This rating is for programs that are intended for adults only. 19-rated programming cannot air during the hours of 7:00AM to 9:00AM, and 1:00PM to 10:00PM. Programmes that receive this rating will almost certainly have adult themes, sexual situations, frequent use of strong language and disturbing scenes of violence.",
        order: 5,
      },
      {
        certification: "Exempt",
    ...
    PT: [
      ...
      },
      {
        certification: "16",
        meaning:
          "Not suitable for children under 16, access to these programs is locked by a personal password.",
        order: 4,
      },
      {
        certification: "T",
      ...
      },
      {
        certification: "10AP",
        meaning:
          "Acompanhamento Parental (may not be suitable for children under 10, parental guidance advised).",
        order: 2,
      },
    ],
    PH: [
      ...
      },
      {
        certification: "X",
        meaning:
          "Any television program that does not conform to the “G”, “PG”, and “SPG” classification shall be disapproved for television broadcast.",
        order: 4,
      },
      {
        certification: "SPG",
    ...
    "CA-QC": [
      {
        certification: "G",
        meaning:
          "Appropriate for all ages and must contain little or no violence and little to no sexual content.",
        order: 1,
      },
      {
        certification: "8+",
        meaning:
          "Appropriate for children 8 and up may contain with little violence, language, and little to no sexual situations.",
        order: 2,
      },
      {
        certification: "16+",
        meaning:
          "Recommended for children over the age of 16 and may contain with strong violence, strong language, and strong sexual content.",
        order: 4,
      },
      {
        certification: "13+",
        meaning:
          "Appropriate – suitable for children 13 and up and may contain with moderate violence, language, and some sexual situations.",
        order: 3,
      },
      {
        certification: "NR",
    ...
    HU: [
      ...
      },
      {
        ...
        meaning:
          "Programs recommended for children. It is an optional rating, there is no obligation for broadcasters to indicate it.",
        order: 2,
      },
      {
        certification: "16",
        meaning:
          "Programs not recommended for teens and children below the age of 16, may contain more intensive violence and sexual content. A yellow circle with the number 16 written inside is used for this rating.",
        order: 5,
      },
      {
        certification: "18",
        meaning:
          "The program is recommended only for adult viewers (for ages 18 and up), may contain explicit violence and explicit sexual content. A red circle with the number 18 written inside is used for this rating (the red circle was also used until 2002, but it did not contain any number in it).",
        order: 6,
      },
      {
        certification: "NR",
      ...
      },
      {
        certification: "6",
        meaning:
          "Programs not recommended for children below the age of 6, may not contain any violence or sexual content. A yellow circle with the number 6 written inside is used for this rating.",
        order: 3,
      },
      {
        certification: "12",
        meaning:
          "Programs not recommended for children below the age of 12, may contain light sexual content or explicit language. Most films without serious violence or sexual content fit into this category as well. A yellow circle with the number 12 written inside is used for this rating.",
        order: 4,
      },
    ],
    RU: [
    ...
    GB: [
      ...
      },
      {
        certification: "12A",
        meaning:
          "Films classified 12A and video works classified 12 contain material that is not generally suitable for children aged under 12. 12A requires an adult to accompany any child under 12 seeing a 12A film at the cinema.",
        order: 2,
      },
      {
        certification: "15",
    ...
    LT: [
      ...
      },
      {
        certification: "N-14",
        meaning:
          "Intended for viewers from 14 years of age and broadcast from 21 (9pm) to 6 (6am) hours.",
        order: 2,
      },
      {
        certification: "S",
    ...
    FR: [
      {
        certification: "16",
        meaning:
          "Not recommended for children under 16. Not allowed air before 10:30 p.m. Some channels and programs are subject to exception.",
        order: 3,
      },
      {
        certification: "NR",
      ...
      },
      {
        certification: "10",
        meaning:
          "Not recommended for children under 10. Not allowed in children's television series.",
        order: 1,
      },
      {
        certification: "12",
        meaning:
          "Not recommended for children under 12. Not allowed air before 10:00 p.m. Some channels and programs are subject to exception.",
        order: 2,
      },
      {
        certification: "18",
        meaning:
          "Not recommended for persons under 18. Allowed between midnight and 5 a.m. and only in some channels, access to these programs is locked by a personal password.",
        order: 4,
      },
    ],
  },
...
const movieGenres = [
  ...
  {
    id: 12,
    name: i18n.t("Adventure"),
    isNotPressed: true,
  },
  {
    id: 16,
    name: i18n.t("Animation"),
    isNotPressed: true,
  },
  {
    id: 35,
...
export default { companies, ratings, type, movieGenres, tvGenres };
